...
import { Shield, Radar, Zap, CheckCircle2, MailCheck, Server, Activity } from 'lucide-react';
...
export default function PremiumPricing() {
  ...
  // Calculate 20% discount if annual is selected
    ...
    <div className="relative min-h-screen bg-[#03050a] py-32 px-6 overflow-hidden font-sans">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <motion.div initial="hidden" animate="visible" variants={fadeUp} className="text-center mb-12">
          ...
          <h1 className="text-5xl md:text-6xl font-black text-white mb-6 tracking-tight">Fair pricing. Zero waste.</h1>
          <p className="text-xl text-slate-400 max-w-2xl mx-auto mb-10">
            Start free, upgrade when you need to. Unused credits roll over forever.
          </p>
          ...
          <div className="flex items-center justify-center gap-4">
            ...
            <button 
              ...
              className="relative w-16 h-8 rounded-full bg-slate-800 border border-slate-700 flex items-center px-1 transition-colors hover:bg-slate-700"
            >
              <motion.div 
                animate={{ x: isAnnual ? 32 : 0 }} 
                transition={{ type: "spring", stiffness: 500, damping: 30 }}
                className="w-6 h-6 rounded-full bg-sky-500 shadow-[0_0_10px_rgba(56,189,248,0.5)]"
              />
            </button>
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-16">
          ...
          <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.1 }} className="bg-white/[0.02] backdrop-blur-xl border border-white/10 rounded-[3rem] p-8 md:p-10 flex flex-col hover:bg-white/[0.04] transition-colors h-full">
            <div className="mb-8">
              <div className="text-sky-400 text-xs font-black uppercase tracking-widest mb-4">Forever Free</div>
              <h3 className="text-4xl font-black text-white mb-2">Sandbox</h3>
              <div className="text-6xl font-black text-white mb-2 tracking-tighter">$0<span className="text-2xl text-slate-500 font-medium pb-2">/mo</span></div>
            </div>
            
            <div className="flex-1 space-y-4 mb-8">
              <div className="flex items-start gap-3 text-slate-300">
                <CheckCircle2 className="w-5 h-5 text-emerald-400 shrink-0 mt-0.5" />
                <span className="font-medium">150 Verification Credits</span>
              </div>
              <div className="flex items-start gap-3 text-slate-300">
                <CheckCircle2 className="w-5 h-5 text-emerald-400 shrink-0 mt-0.5" />
                <span className="font-medium">Dual-Threat Analyzer <span className="text-slate-500 text-sm block font-normal">Test payload & spam triggers</span></span>
              </div>
              <div className="flex items-start gap-3 text-slate-300">
                <CheckCircle2 className="w-5 h-5 text-emerald-400 shrink-0 mt-0.5" />
                <span className="font-medium">Spam-proof Composer</span>
              </div>
            </div>
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.2 }} className="lg:col-span-2 bg-gradient-to-br from-[#0a0f1c] to-[#050810] backdrop-blur-2xl border border-sky-500/30 shadow-[0_0_50px_rgba(56,189,248,0.05)] rounded-[3rem] p-8 md:p-10 relative overflow-hidden">
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start relative z-10">
              ...
              <div>
                ...
                <div className="mb-10 relative">
                  ...
                  <input 
                    ...
                    className="w-full h-2 bg-slate-800 rounded-lg appearance-none cursor-pointer accent-sky-500 hover:accent-sky-400 transition-all relative z-10"
                  />
                </div>
              ...
              {/* Right: Vault Allocations & Features */}
              <div className="flex flex-col h-full">
                <div className="bg-black/40 backdrop-blur-md p-6 rounded-[2rem] border border-white/5 mb-6">
                  <div className="mb-6">
                    <div className="flex justify-between items-center mb-1">
                      ...
                      <motion.span key={pricingTiers[sliderIndex].iCredits} initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-emerald-400 font-black text-xl">
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-1">
                      ...
                      <motion.span key={pricingTiers[sliderIndex].dCredits} initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-sky-400 font-black text-xl">
                ...
                {/* Feature List (Command Center mapping) */}
                <div className="space-y-3 px-2">
                  <div className="flex items-center gap-3 text-slate-300 text-sm">
                    <CheckCircle2 className="w-4 h-4 text-sky-400 shrink-0" />
                    <span className="font-medium">100% Infinite Credit Rollover</span>
                  </div>
                  <div className="flex items-center gap-3 text-slate-300 text-sm">
                    <CheckCircle2 className="w-4 h-4 text-sky-400 shrink-0" />
                    <span className="font-medium">Bulk CSV Verification Engine</span>
                  </div>
                  <div className="flex items-center gap-3 text-slate-300 text-sm">
                    <CheckCircle2 className="w-4 h-4 text-sky-400 shrink-0" />
                    <span className="font-medium">Global Proxy Network Extractor</span>
                  </div>
                  <div className="flex items-center gap-3 text-slate-300 text-sm">
                    <Server className="w-4 h-4 text-indigo-400 shrink-0" />
                    <span className="font-medium">Sub-200ms API Hub Access</span>
                  </div>
                  <div className="flex items-center gap-3 text-slate-300 text-sm">
                    <Activity className="w-4 h-4 text-indigo-400 shrink-0" />
                    <span className="font-medium">DNS Armor Protocol & Domain Monitor</span>
                  </div>
                </div>
              </div>
            </div>
