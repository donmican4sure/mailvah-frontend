...
// Initialize Supabase directly for bulletproof mobile deployment
...
export default function RegisterPage() {
  ...
  const handleSignup = async (e) => {
    ...
    try {
      ...
      // 3. Send them to the dashboard after 2 seconds
      setTimeout(() => {
  ...
  return (
    <div className="min-h-screen bg-[#0B0F19] flex flex-col items-center justify-center p-4 selection:bg-blue-500/30 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-slate-900/80 backdrop-blur-xl border border-slate-800 rounded-3xl p-8 shadow-2xl relative z-10 animate-in fade-in slide-in-from-bottom-4">
        ...
        <h2 className="text-2xl font-black text-white mb-2">Start verifying emails.</h2>
        <p className="text-slate-400 text-sm font-medium mb-8">Create your free account. No credit card required.</p>
        ...
        <form onSubmit={handleSignup} className="space-y-5">
          <div>
            ...
            <div className="relative">
              ...
              <input 
                ...
                className="w-full bg-[#050810] border border-slate-800 rounded-xl pl-11 pr-4 py-3.5 text-white focus:border-blue-500 focus:ring-1 focus:ring-blue-500 focus:outline-none font-medium transition-all" 
          ...
          <button 
            type="submit" 
            disabled={loading}
            className="w-full bg-blue-600 hover:bg-blue-500 text-white font-black py-4 rounded-xl shadow-lg shadow-blue-900/20 mt-2 transition-all hover:scale-[1.02] flex justify-center items-center disabled:opacity-50 disabled:hover:scale-100"
          >
